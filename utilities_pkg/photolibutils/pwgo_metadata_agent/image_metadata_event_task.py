...
from .database_event_row import ImageMetadataEventRow
...
class ImageMetadataEventTask(EventTask):
    ...
    def __init__(self, image_id, **kwargs):
        ...
        if "delay" in kwargs:
            ...
            self._std_delay = Constants.IMG_TAG_WAIT_SECS
        self._included_tags = {}
        self._included_cats = {}
    ...
    @classmethod
    def resolve_event_task(cls, evt: ImageMetadataEventRow) -> asyncio.Future:
    ...
    def _reset_delay(self, **kwargs):
        ...
        if "delay" in kwargs:
            ...
            delay = Constants.IMG_TAG_WAIT_SECS
    ...
    def add_event(self, evt: ImageMetadataEventRow):
    ...
    def _add_category_event(self, category_id, oper):
        ...
        if category_id == Constants.AUTO_TAG_ALB:
    ...
    async def _handle_events(self):
        ...
        async with AutoTagger.create(self.image_id) as tagger:
            ...
            if Enumerable(self._included_cats.values()).any(lambda x: x > 0):
...
EventTask.register_table_task_type("image_tag", ImageMetadataEventTask)
EventTask.register_table_task_type("image_category", ImageMetadataEventTask)
EventTask.register_table_task_type("images", ImageMetadataEventTask)
