...
from ...pwgo_metadata_agent.database_event_row import ImageMetadataEventRow
from ...pwgo_metadata_agent.event_task import EventTask
from ...pwgo_metadata_agent.image_metadata_event_task import ImageMetadataEventTask
from ...pwgo_metadata_agent.image_metadata_event_task import AutoTagger
...
class TestImageMetadataEventTask:
    ...
    async def test_reset_delay(self):
        ...
        evt_row1 = ImageMetadataEventRow(image_id=1,
        ...
        with patch.object(AutoTagger,"create") as mck_atag_create:
            ...
            evt_row2 = ImageMetadataEventRow(image_id=1,
                table_name="image_tag",
    ...
    async def test_reset_after_task_start(self):
        ...
        with patch.object(AutoTagger,"create") as mck_atag_create:
            ...
            tag_event_handler = await EventTask.get_event_task(evt_row1)
            tag_event_handler.schedule_start()
            await asyncio.sleep(Constants.IMG_TAG_WAIT_SECS + 1)
